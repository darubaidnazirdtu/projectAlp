...
import { set, get, getByTrainingId, getByDepartmentId, update, deleteTraining } from "../data-access/revenue_from_corporate_training.data-access.js"

const enterData = asyncHandler(async (req, res) => {
    const data = req.body

    // Validation based on tableConfig required fields
    const requiredFields = ['department_id', 'name_of_program', 'agency_name', 'type_of_agency', 'duration_start_date', 'end_date', 'year_of_training', 'revenue_generated', 'mode_of_training'];
