...
import { set, get, getByActivityId, getByDepartmentId, update, deleteActivity } from "../data-access/collaborative_activities.data-access.js"
...
const enterData = asyncHandler(async (req, res) => {
    ...
    const requiredFields = ['department_id', 'title_of_activity', 'name_of_collaborative_agency', 'type_of_activity', 'level', 'start_date', 'end_date', 'year', 'academic_year'];
