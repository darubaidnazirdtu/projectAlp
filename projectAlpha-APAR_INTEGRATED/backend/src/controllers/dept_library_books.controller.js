...
import { set, get, getByBookId, getByDepartmentId, update, deleteBook } from "../data-access/dept_library_books.data-access.js"
...
const enterData = asyncHandler(async (req, res) => {
    ...
    const requiredFields = ['department_id', 'title_of_book', 'author', 'publisher', 'year_of_publication', 'no_of_copies'];
...
const getById = asyncHandler(async (req, res) => {
    ...
    const response = await getByBookId(id)
    if (!response) {
