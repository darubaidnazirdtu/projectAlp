...
import { set, get, getByTrainingId, getByDepartmentId, update, deleteTraining } from "../data-access/professional_training_staff.data-access.js";
...
const enterData = asyncHandler(async (req, res) => {
    ...
    const requiredFields = ['department_id', 'title_of_event', 'type_of_training', 'mode', 'start_date', 'end_date', 'academic_year', 'number_of_participants'];
