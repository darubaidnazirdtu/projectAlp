...
import { set, get, getByMouId, getByDepartmentId, update, deleteMou } from "../data-access/functional_mous.data-access.js"
...
const enterData = asyncHandler(async (req, res) => {
    ...
    const requiredFields = ['department_id', 'organisation_name', 'purpose', 'start_date', 'activities_under_mou', 'type_of_mou', 'level', 'year_of_signing', 'academic_year'];
...
const getById = asyncHandler(async (req, res) => {
    ...
    const response = await getByMouId(id)
    if (!response) {
