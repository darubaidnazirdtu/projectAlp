...
import { set, get, getByFundingId, getByDepartmentId, getByStatus, getByFundingType, update, deleteFunding } from "../data-access/research_funding.data-access.js"
...
const enterData = asyncHandler(async (req, res) => {
    ...
    const requiredFields = ['department_id', 'title_research', 'type_of_project', 'funding_agency_name', 'funding_type', 'year_of_sanction', 'academic_year', 'start_date', 'end_date', 'amount', 'status'];
...
const getById = asyncHandler(async (req, res) => {
    ...
    const response = await getByFundingId(id)
    if (!response) {
