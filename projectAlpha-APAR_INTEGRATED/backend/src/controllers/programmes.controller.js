...
import { set, get, getByProgrammeId, getByDepartmentId, getByLevel, update, deleteProgramme } from "../data-access/programmes.data-access.js"

const enterData = asyncHandler(async (req, res) => {
    const data = req.body

    // Validation based on tableConfig required fields
    const requiredFields = ['programme_name', 'department_id', 'level', 'duration_years'];
