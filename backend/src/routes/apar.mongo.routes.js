...
import { deleteSavedDocument, deleteTemporaryDocument, streamDocument, uploadTemporaryDocument, uploadDirectMinioDocument } from '../controllers/apar-document.controller.js';
...
router.route('/documents/direct').post(authenticate, uploadAparTemporaryDocument.single('file'), uploadDirectMinioDocument);
router.route('/documents').delete(authenticate, deleteSavedDocument);
