...
import { set, get, getByVisitId, getByDepartmentId, getByFacultyId, update, deleteVisit } from "../data-access/faculty_visits.data-access.js"
...
const enterData = asyncHandler(async (req, res) => {
    ...
    const requiredFields = ['faculty_id', 'department_id', 'organisation_name', 'title', 'visit_type', 'purpose', 'location', 'level', 'start_date', 'end_date', 'academic_year', 'year_of_sanction'];
...
const getById = asyncHandler(async (req, res) => {
    ...
    const response = await getByVisitId(id)
    if (!response) {
