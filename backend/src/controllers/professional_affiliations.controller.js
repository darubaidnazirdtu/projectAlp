...
import { set, get, getByAffiliationId, getByDepartmentId, getByFacultyId, update, deleteAffiliation } from "../data-access/professional_affiliations.data-access.js"
...
const enterData = asyncHandler(async (req, res) => {
    ...
    const requiredFields = ['faculty_id', 'department_id', 'professional_body_name', 'type_of_membership', 'level', 'start_date', 'status', 'academic_year', 'year_of_sanction'];
...
const getById = asyncHandler(async (req, res) => {
    ...
    const response = await getByAffiliationId(id)
    if (!response) {
