...
import { set, get, getBySupportId, getByDepartmentId, update, deleteSupport } from "../data-access/student_financial_support_events.data-access.js";

const enterData = asyncHandler(async (req, res) => {
    const data = req.body

    // Auto-injected JSON parsing for object lists
    ;["students","external_recipients"].forEach(field => {
    ...
    const requiredFields = ['department_id', 'date_of_event', 'name_of_event', 'type_of_support', 'amount_of_support', 'academic_year', 'year_of_sanction'];
