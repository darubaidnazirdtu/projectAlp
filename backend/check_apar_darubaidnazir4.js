...
async function test() {
    ...
    console.log("User ID in form:", form.user_id);
    console.log("Faculty Name:", form.facultyName);
    console.log("Personal info:", JSON.stringify(form.part1?.personal_info, null, 2));
